...
<div id = "headerLeft"></div>
    ...
    <a href = "login_index.php" target="_blank"><span class = "headerSpan">LOGIN</span></a>
	</div>
</header>
<div id = "centerDiv">
    ...
    <div id = "gamesContainer">
            ...
            <div class = "gamecontent">
                ...
                <div class = "gamecontentBody"> 
                    ...
                    The genre is seen as a fusion of real-time strategy, role-playing, and action games.
                        <a href = "login_index.php" target="_blank"><span class = "showmore">LEARN MORE >></span></a>
                    </p>
        ...
        <a href = "login_index.php" target="_blank"><span class = "showall">>>> &nbsp;&nbsp;&nbsp;LEARN MORE? CLICK HERE&nbsp;&nbsp;&nbsp; <<<</span></a>
        </div>
        <div id = "footer">
...
function scrollFunction() {
  if (document.body.scrollTop > 10 || document.documentElement.scrollTop > 10) {
    ...
    centerLogo.style.width = "650.04px";
    centerLogo.style.left = "calc((100% - 650.04px)/2)";
